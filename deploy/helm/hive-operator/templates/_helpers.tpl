...
app.kubernetes.io/name: {{ include "hive-operator.appname" . }}
...
{{- default (printf "%s-serviceaccount" (include "hive-operator.fullname" .)) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "hive-operator.testLabels" -}}
helm.sh/test: {{ include "hive-operator.chart" . }}
{{- end }}

{{/*
Build the full operator container image reference.
*/}}
{{- define "hive-operator.image" -}}
