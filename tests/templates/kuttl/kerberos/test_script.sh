...
kinit -kt /stackable/kerberos/keytab hive/access-hive.$NAMESPACE.svc.cluster.local
klist

cat /stackable/conf/hdfs_mount/core-site.xml
cat /stackable/conf/hdfs_mount/hdfs-site.xml
