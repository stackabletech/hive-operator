...
Unfortunately, Hive up until the latest 3.3.x version ships with JDBC drivers that do _not_ support this method.
...
This installes PostgreSQL in version 10 to work around the issue mentioned above:
[source,bash]
----
