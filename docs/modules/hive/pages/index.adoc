...
For this reason in the Stackable Data Platform we decided to provide [Trino](https://github.com/stackabletech/trino-operator) as query engine instead of Hive - which still uses the Hive Metastore, hence this operator exists.
