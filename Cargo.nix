...
rec {
  ...
  rootCrate = rec {
    packageId = "stackable-hive-operator";
    ...
    crates = {
      ...
      "k8s-version" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "a21b8bd33081b66fcb5d296ff51fd34d17ecc422";
          sha256 = "0k5s32fq0938raw0qjblavmgzn27rg3j26djzm5qq4142rv815av";
        };
        libName = "k8s_version";
        authors = [
      ...
      "toml_edit" = rec {
        ...
        edition = "2021";
        sha256 = "1qaw4p1rkkvhml66k2z62lavfwsiljjn761d2javqn1pwq9pk850";
        dependencies = [
          {
            name = "indexmap";
            packageId = "indexmap";
