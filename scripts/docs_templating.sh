...
chmod +x "docs/modules/hive-operator/examples/getting_started/getting_started.sh" \
  || chmod +x "docs/modules/hive-operator/examples/getting_started/code/getting_started.sh" \
  || true
